...
export const EnhancedHeader: React.FC<EnhancedHeaderProps> = ({ 
  ...
  return (
    <>
      <div className="h-12 bg-[#15151f] border-b border-[#2a2a3e] flex items-center justify-between px-4 relative z-30" data-testid="enhanced-header">
        {/* Left side - Logo and branding */}
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 bg-gradient-to-br from-[#00bbff] to-[#4a4aff] rounded-lg flex items-center justify-center">
              <span className="text-white font-bold text-xs">N</span>
            </div>
            <div className="flex items-center">
              <span className="text-base font-bold bg-gradient-to-r from-[#00bbff] to-[#4a4aff] bg-clip-text text-transparent">
                Testing Terminal
              </span>
            </div>
          </div>
        ...
        {/* Right side - Controls */}
        <div className="flex items-center gap-2 md:gap-2 sm:gap-3">
          <SoundControls />

          {/* Persistent Spend/Usage Meter */}
          <div
            className="flex items-center gap-2 px-3 py-2 md:py-1 rounded-lg border border-[#2a2a3e] bg-[#0e111a] shadow-sm cursor-pointer min-h-[44px] md:min-h-[auto] touch-manipulation"
          ...
          <Button
            ...
            className="min-h-[44px] md:min-h-[auto] px-4 md:px-3 touch-manipulation"
          >
            Sync
          </Button>
          ...
          <Button
            ...
            className="bg-[#00bbff] hover:bg-[#0099dd] text-white min-h-[44px] md:min-h-[auto] px-4 md:px-3 touch-manipulation"
            title="Run Backtest"
          >
          ...
          <Button
            ...
            className="min-h-[44px] md:min-h-[auto] min-w-[44px] md:min-w-[auto] touch-manipulation"
          >
          ...
          <Button
            ...
            className={`min-h-[44px] md:min-h-[auto] min-w-[44px] md:min-w-[auto] touch-manipulation ${showSettings ? "bg-[#2a2a3e]" : ""}`}
            title="Settings"
          >
          ...
          <div className="relative">
            <Button
              ...
              className="flex items-center gap-2 min-h-[44px] md:min-h-[auto] px-3 md:px-2 touch-manipulation"
            >
