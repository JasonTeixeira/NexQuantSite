      ...
      <Card className="bg-[#0e111a] border-[#2a2a3e]">
        ...
        <CardContent className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <span className={`text-xs font-mono ${getPerformanceColor(60 - metrics.fps, [5, 15])}`}>
                {metrics.fps}
              </span>
          ...
          <div className="space-y-1">
            <div className="flex items-center justify-between">
              ...
              <span className={`text-xs font-mono ${getPerformanceColor(metrics.memoryUsage, [50, 100])}`}>
          ...
          <div className="space-y-1">
            <div className="flex items-center justify-between">
              ...
              <span className={`text-xs font-mono ${getPerformanceColor(metrics.bundleSize, [300, 500])}`}>
