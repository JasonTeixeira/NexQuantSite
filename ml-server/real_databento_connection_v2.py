...
class RealDatabentoConnectorV2:
    ...
    def __init__(self):
        ...
        logger.info("Real Databento Connector V2 initialized")
    ...
    async def run_full_download(self):
        ...
        logger.info("STARTING REAL DATABENTO DATA DOWNLOAD V2")
        logger.info("=" * 60)
        ...
        summary_file = "ml-platform/databento_download_summary_v2.json"
...
async def main():
    """Main function"""
    logger.info("REAL DATABENTO CONNECTION V2 LAUNCHER")
    logger.info("=" * 60)

    # Initialize connector
    connector = RealDatabentoConnectorV2()
